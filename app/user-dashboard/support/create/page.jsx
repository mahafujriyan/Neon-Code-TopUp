...
export default function CreateTicketPage({ onBack, onSuccess }) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F1F5F9] relative overflow-hidden">
      ...
      {/* Header */}
      <div className="px-4 sm:px-6 py-4 sm:py-5 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between sticky top-0 z-20 shadow-sm">
        <div className="flex items-center gap-3 sm:gap-4 min-w-0">
          ...
          <div className="min-w-0">
            <h1 className="text-base sm:text-lg font-black text-gray-800 tracking-tight">Create Ticket</h1>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-[32px] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden transition-all">
            ...
            <div className="p-5 sm:p-6 md:p-10 space-y-8">
              {/* Intro Text */}
                <div className="flex items-start gap-3 sm:gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  {files.map((file, index) => (
                    <div key={index} className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden ring-4 ring-gray-50 shadow-md animate-in zoom-in duration-300">
                  ...
                  {files.length < 4 && (
                    <label className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50 flex flex-col items-center justify-center gap-1 cursor-pointer hover:border-[#10B981] hover:bg-[#10B981]/5 transition-all group">
